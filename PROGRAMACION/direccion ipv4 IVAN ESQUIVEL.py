#JESUS IVAN ESQUIVRL RUIZ
# NOMBRE DEL PROGRAMA: DIRECCION IPV4
# NOMBRE DEL LENGUAJE:PYTHON
# DESCRIPCION DEL PROGRAMA: ESTE PROGRAMA TRATA DE GENERAR UNA DIRECCION IPV4 A PARTIR DE SUS ESTANDARES QUE LA CONTIENEN Y SI EL USUARIO LO DECIDE PUEDE SALIR DEL PROGRAMA
# FECHA:14/02/2025
# ULTIMA MODIFICACION:14/02/2025
